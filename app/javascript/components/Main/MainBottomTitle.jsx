...
const MainBottomTitle = () => {
  ...
  return (
    <div className="main_bottom_title">
      <div className="main_bottom_title_main">電気料金の比較</div>
      <div className="main_bottom_title_process">
        <div
          className="main_bottom_title_process_num page1"
          onClick={onClickTo1}
          onKeyPress={onClickTo1}
          role="button"
          tabIndex="-1"
        >
          1
        ...
        <div
          className="main_bottom_title_process_num page2"
          onClick={onClickTo2}
